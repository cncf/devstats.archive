...
- Go version: `time GHA2DB_RESETIDB=1 PG_PASS='Admin123_#' IDB_PASS='Admin123_#' PG_DB=test IDB_DB=test ./sync_go.sh`
```
real  1m28.336s
user  1m54.352s
sys 1m11.860s
```
- Ruby version: `time GHA2DB_PSQL=1 GHA2DB_RESETIDB=1 PG_PASS='Admin123_#' IDB_PASS='Admin123_#' PG_DB=test IDB_DB=test ./sync_ruby.sh`
```
real  1m46.342s
user  0m51.488s
sys 0m27.408s
