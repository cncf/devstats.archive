...
GHA2DB_PROJECT=linkerd IDB_DB=linkerd PG_DB=linkerd GHA2DB_LOCAL=1 GHA2DB_EXACT=1 ./gha2db 2016-01-13 0 today now 'BuoyantIO/linkerd' 2>>errors.txt | tee -a run.log || exit 2
