...
GHA2DB_PROJECT=jenkinsx PG_DB=jenkinsx GHA2DB_LOCAL=1 gha2db 2018-02-01 0 today now "jenkins-x,jenkins-x-quickstarts,jenkins-x-apps,jenkins-x-charts,jenkins-x-buildpacks,jenkins-x-images,jenkins-x-plugins" 2>>errors.txt | tee -a run.log || exit 2
