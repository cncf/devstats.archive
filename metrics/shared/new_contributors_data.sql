with prev as (
  ...
  select distinct pr.user_id,
    ...
    first_value(pr.dup_repo_id) over prs_by_created_at as repo_id,
    first_value(pr.dup_repo_name) over prs_by_created_at as repo_name,
    first_value(pr.event_id) over prs_by_created_at as event_id
  from
