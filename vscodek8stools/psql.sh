...
GHA2DB_PROJECT=vscodek8stools PG_DB=vscodek8stools GHA2DB_LOCAL=1 gha2db 2017-08-03 0 today now 'vscode-kubernetes-tools,Azure/vscode-kubernetes-tools' 2>>errors.txt | tee -a run.log || exit 2
