...
GHA2DB_LOCAL=1 GHA2DB_SKIP_TAGS=1 GHA2DB_SKIP_ANNOTATIONS=1 GHA2DB_SKIP_COLUMNS=1 GHA2DB_SKIPPDB=1 GHA2DB_STARTDT_FORCE=1 GHA2DB_STARTDT="$1" GHA2DB_RESETTSDB=1 GHA2DB_FORCE_PERIODS="$2" ./gha2db_sync
