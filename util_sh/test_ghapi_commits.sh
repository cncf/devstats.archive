...
# DTFROM="2018-10-01" REPO="cncf/landscape" GHA2DB_GHAPISKIPEVENTS=1 PG_DB=cncf ghapi2db
# DTFROM="2018-10-01" GHA2DB_GHAPISKIPEVENTS=1 PG_DB=cncf ghapi2db
# DTFROM="2018-06-01" GHA2DB_GHAPISKIPEVENTS=1 PG_DB=cncf ghapi2db
# DTFROM="2018-06-01" REPO="cncf/k8s-conformance" GHA2DB_GHAPISKIPEVENTS=1 PG_DB=cncf ghapi2db
...
DTFROM="2018-10-15" REPO="cncf/devstats" GHA2DB_DEBUG=2 GHA2DB_GHAPISKIPEVENTS=1 GHA2DB_ST=1 PG_DB=cncf ghapi2db
