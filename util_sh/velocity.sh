...
GHA2DB_SKIPTIME=1 GHA2DB_SKIPLOG=1 GHA2DB_CSVOUT="velocity.csv" ./runq util_sql/velocity.sql {{exclude_bots}} "`cat util_sql/exclude_bots.sql`" {{types}} "$1" {{date_from}} "$2" {{date_to}} "$3"
