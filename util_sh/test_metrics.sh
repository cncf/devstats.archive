...
#GHA2DB_LOCAL=1 GHA2DB_PROJECT=kubernetes GHA2DB_SKIPTIME=1 GHA2DB_SKIPLOG=1 GHA2DB_DEBUG=1  ./calc_metric multi_row_multi_column ./metrics/kubernetes/issues_age.sql '2014-06-01 0' '2018-05-07 17' y desc:time_diff_as_string
#GHA2DB_LOCAL=1 GHA2DB_PROJECT=kubernetes GHA2DB_SKIPTIME=1 GHA2DB_SKIPLOG=1 GHA2DB_DEBUG=1  ./calc_metric multi_row_multi_column ./metrics/kubernetes/time_metrics.sql '2014-06-01 0' '2018-05-07 17' y desc:time_diff_as_string
