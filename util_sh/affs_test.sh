...
ONLY="crio networkservicemesh openebs opentelemetry thanos flux intoto strimzi cncf opencontainers istio knative" GHA2DB_PROJECTS_OVERRIDE="+cncf,+opencontainers,+istio,+knative" ./devel/all_affs.sh || exit 7
GHA2DB_RECENT_RANGE="4 hours" GHA2DB_TMOFFSET="-4" GHA2DB_PROJECTS_OVERRIDE="+cncf,+opencontainers,+istio,+knative" devstats
