...
GHA2DB_PROJECT=azf PG_DB=azf GHA2DB_LOCAL=1 gha2db 2015-04-27 0 today now 'Azure/azure-functions-host,Azure/azure-webjobs-sdk,Azure/azure-webjobs-sdk-extensions,Azure/azure-functions-durable-extension,Azure/azure-functions-durable-js,Azure/azure-functions-core-tools,Azure/azure-functions-nodejs-worker,Azure/azure-functions-java-worker,Azure/azure-functions-python-worker,Azure/azure-functions-ux,Azure/azure-functions-templates,Azure/azure-webjobs-sdk-script-samples,Azure/azure-functions-vs-build-sdk,Azure/azure-webjobs-sdk-script,Azure/azure-webjobs-sdk-templates,Azure/azure-functions-cli,projectkudu/AzureFunctions,projectkudu/WebJobsPortal,projectkudu/AzureFunctionsPortal,projectkudu/azure-functions-ux' 2>>errors.txt | tee -a run.log || exit 2
