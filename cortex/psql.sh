...
GHA2DB_PROJECT=cortex PG_DB=cortex GHA2DB_LOCAL=1 ./gha2db 2016-09-09 0 today now weaveworks 'cortex,prism,frankenstein' 2>>errors.txt | tee -a run.log || exit 2
