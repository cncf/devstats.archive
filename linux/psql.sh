...
GHA2DB_PROJECT=linux PG_DB=linux GHA2DB_LOCAL=1 GHA2DB_OLDFMT=1 GHA2DB_EXACT=1 ./gha2db 2014-01-01 0 2014-12-31 23 'torvalds/linux,linux' 2>>errors.txt | tee -a run.log || exit 3
