...
then
  ...
  args="${args},prometheus,opentracing,fluent,linkerd,BuoyantIO/linkerd,grpc,miekg/coredns,coredns,containerd,docker/containerd,rkt,coreos/rkt,coreos/rocket,rktproject/rkt,containernetworking,appc/cni,envoyproxy,lyft/envoy,jaegertracing,uber/jaeger,theupdateframework,docker/notary,rook,vitessio,youtube/vitess,nats-io,apcera/nats,apcera/gnatsd,kubevela"
  ...
  args="${args},vmware-tanzu/carvel-vendir,vmware-tanzu/carvel-kwt,vmware-tanzu/carvel-secretgen-controller,kubereboot,istio,inclavare-containers"
