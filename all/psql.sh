...
then
  ...
  args="${args},yahoo/athenz,alauda/kube-ovn,curiefense,distribution,kubeovn,AthenZ,openyurtio,foniod,ingraind,redsift/ingraind,Comcast/kuberhealthy,AbsaOSS/k8gb,AbsaOSS/ohmyglb,tricksterproxy,Comcast/trickster,emissary-ingress,datawire/ambassador,kuberhealthy,wasmerio,WAFoundation,wafoundation,getwasmer,wampio/wasmer,chaosblade-io,alibaba/v6d,alibaba/libvineyard,vmware-tanzu/antrea"
  args="${args},fluid-cloudnative,cheyang/fluid,submariner-io,rancher/submariner"
