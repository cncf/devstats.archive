...
then
  ...
  args="${args},projectcontour,operator-framework,heptio/contour,chaos-mesh,serverlessworkflow,pingcap/chaos-mesh,cncf/wg-serverless-workflow,skooner-k8s,antrea-io,project-akri,dapr,kubesphere/openelb,kubesphere/porterlb,kubesphere/porter,open-cluster-management-io,open-cluster-management,Azure/vscode-kubernetes-tools,vscode-kubernetes-tools,nocalhost,kubearmor,accuknox/KubeArmor,k8up-io,vshn/k8up,kube-rs,clux/kube-rs,clux/kubernetes-rust"
