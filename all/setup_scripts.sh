...
sudo -u postgres psql allprj -c "insert into gha_postprocess_scripts(ord, path) select 0, 'scripts/all/repo_groups.sql' on conflict do nothing"
...
PG_DB=allprj ./runq util_sql/repo_groups_postprocess_script_from_repos.sql
