...
GHA2DB_PROJECT=opentracing IDB_DB=opentracing PG_DB=opentracing GHA2DB_LOCAL=1 ./gha2db 2015-01-01 0 today now 'opentracing' 2>>errors.txt | tee -a run.log || exit 2
