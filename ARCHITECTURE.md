...
- `import_affs` takes one parameter - JSON file name (this is a file from [cncf/gitdm](https://github.com/cncf/gitdm): [github_users.json](https://github.com/cncf/gitdm/raw/master/src/github_users.json)
