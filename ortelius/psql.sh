...
GHA2DB_PROJECT=ortelius PG_DB=ortelius GHA2DB_LOCAL=1 gha2db 2017-03-06 0 today now "ortelius,DeployHubProject,OpenMake-Software" 2>>errors.txt | tee -a run.log || exit 2
