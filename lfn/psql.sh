...
GHA2DB_PROJECT=lfn PG_DB=lfn GHA2DB_LOCAL=1 ./gha2db 2018-11-01 0 today now 'iovisor,mininet,opennetworkinglab,opensecuritycontroller,open-switch,p4lang,openbmp,tungstenfabric,opencord' 2>>errors.txt | tee -a run.log || exit 3
