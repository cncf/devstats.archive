...
GHA2DB_PROJECT=jenkins PG_DB=jenkins GHA2DB_LOCAL=1 gha2db 2015-01-01 0 today now "jenkinsci,jenkins-infra" 2>>errors.txt | tee -a run.log || exit 2
GHA2DB_PROJECT=jenkins PG_DB=jenkins GHA2DB_LOCAL=1 GHA2DB_OLDFMT=1 GHA2DB_EXACT=1 gha2db 2012-07-01 0 2014-12-31 23 'jenkinsci/jenkins,jenkins,jenkins-infra' 2>>errors.txt | tee -a run.log || exit 3
