...
GHA2DB_PROJECT=jenkins PG_DB=jenkins GHA2DB_LOCAL=1 GHA2DB_OLDFMT=1 GHA2DB_EXACT=1 ./gha2db 2012-07-01 0 2014-12-31 23 'jenkinsci/jenkins,jenkins,jenkinsci' 2>>errors.txt | tee -a run.log || exit 3
