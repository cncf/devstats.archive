...
do
  ...
  if ( [ "$icon" = "keylime" ] || [ "$icon" = "porter" ] || [ "$icon" = "cnigenie" ] || [ "$icon" = "serverlessworkflow" ] || [ "$icon" = "istio" ] || [ "$icon" = "knative" ] || [ "$icon" = "contrib" ] || [ "$icon" = "sam" ] || [ "$icon" = "azf" ] || [ "$icon" = "riff" ] || [ "$icon" = "fn" ] || [ "$icon" = "openwhisk" ] || [ "$icon" = "openfaas" ] || [ "$icon" = "cii" ] )
  then
    icon="cncf"
  fi
