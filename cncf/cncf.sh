...
GHA2DB_PROJECT=cncf IDB_DB=cncf PG_DB=cncf GHA2DB_LOCAL=1 ./gha2db 2015-01-01 0 2017-11-08 0 'cncf' 2>>errors.txt | tee -a run.log || exit 2
...
./cncf/import_affs.sh 2>>errors.txt | tee -a run.log || exit 7
