...
GHA2DB_PROJECT=cncf IDB_DB=cncf PG_DB=cncf GHA2DB_LOCAL=1 ./gha2db 2015-10-01 18 today now 'cncf,crosscloudci' 2>>errors.txt | tee -a run.log || exit 2
...
./cncf/get_repos.sh 2>>errors.txt | tee -a run.log || exit 7
