...
GHA2DB_PROJECT=spiffe IDB_DB=spiffe PG_DB=spiffe GHA2DB_LOCAL=1 ./gha2db 2016-06-04 0 today now 'spiffe' 2>>errors.txt | tee -a run.log || exit 2
...
./spiffe/get_repos.sh 2>>errors.txt | tee -a run.log || exit 7
