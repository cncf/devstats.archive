...
func TestComputePeriodAtThisDate(t *testing.T) {
	...
	var testCases = []struct {
		...
		{period: "a_13_n", dt: ft(2017, 12, 19, 1), expected: true},
		{period: "a_13_n", dt: ft(2017, 12, 19, 2, 11), expected: false},
		...
		{tmOffset: 5, period: "a_13_n", dt: ft(2017, 12, 19, 20), expected: true},
		{tmOffset: 5, period: "a_13_n", dt: ft(2017, 12, 19, 21, 11), expected: false},
		...
		{tmOffset: -10, period: "a_13_n", dt: ft(2017, 12, 19, 11), expected: true},
		{tmOffset: -10, period: "a_13_n", dt: ft(2017, 12, 19, 12, 11), expected: false},
