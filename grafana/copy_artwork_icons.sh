...
do
  ...
  if ( [ "$icon" = "inspektorgadget" ] || [ "$icon" = "clusternet" ] || [ "$icon" = "containerssh" ] || [ "$icon" = "openfga" ] || [ "$icon" = "lima" ] || [ "$icon" = "hexapolicyorchestrator" ] || [ "$icon" = "konveyor" ] || [ "$icon" = "armada" ] || [ "$icon" = "externalsecretsoperator" ] || [ "$icon" = "openfunction" ] || [ "$icon" = "clusterpedia" ] || [ "$icon" = "opencost" ] || [ "$icon" = "curve" ] || [ "$icon" = "kubewarden" ] || [ "$icon" = "devstream" ] || [ "$icon" = "sealer" ] || [ "$icon" = "confidentialcontainers" ] || [ "$icon" = "openelb" ] || [ "$icon" = "vscodek8stools" ] || [ "$icon" = "oras" ] || [ "$icon" = "wasmcloud" ] || [ "$icon" = "servicemeshperformance" ] || [ "$icon" = "kubevip" ] || [ "$icon" = "cnigenie" ] || [ "$icon" = "devspace" ] || [ "$icon" = "capsule" ] || [ "$icon" = "ko" ] || [ "$icon" = "contrib" ] || [ "$icon" = "sam" ] || [ "$icon" = "azf" ] || [ "$icon" = "riff" ] || [ "$icon" = "fn" ] || [ "$icon" = "openwhisk" ] || [ "$icon" = "openfaas" ] || [ "$icon" = "cii" ] )
  then
    icon="cncf"
  fi
