...
docker run --security-opt "apparmor:unconfined" -d -p 127.0.0.1:3002:3000 -v /var/lib/grafana.opentracing:/var/lib/grafana -e "GF_SECURITY_ADMIN_PASSWORD=${GRAFANA_PASS}" grafana/grafana:master
