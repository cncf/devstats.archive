...
tar cf devstats-grafana.tar replacer sqlitedb grafana/shared grafana/img/k8s* grafana/kubernetes/change_title_and_icons.sh grafana/kubernetes/update_sqlite.sql grafana/dashboards/kubernetes/*.json
