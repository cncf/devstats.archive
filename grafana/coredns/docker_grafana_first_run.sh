...
docker run --security-opt "apparmor:unconfined" -d -p 127.0.0.1:3006:3000 -v /var/lib/grafana.coredns:/var/lib/grafana -e "GF_SECURITY_ADMIN_PASSWORD=${GRAFANA_PASS}" grafana/grafana:master
