...
convert ~/dev/cncf/artwork/fluentd/icon/color/fluentd-icon-color.png -resize 32x32 grafana/img/fluentd32.png || exit 21
convert ~/dev/cncf/artwork/linkerd/icon/color/linkerd-icon-color.png -resize 32x32 grafana/img/linkerd32.png || exit 22
convert ~/dev/cncf/artwork/grpc/icon/color/grpc-icon-color.png -resize 32x32 grafana/img/grpc32.png || exit 23
convert ~/dev/cncf/artwork/coredns/icon/color/core-dns-icon-color.png -resize 32x32 grafana/img/coredns32.png || exit 24
convert ~/dev/cncf/artwork/containerd/icon/color/containerd-icon-color.png -resize 32x32 grafana/img/containerd32.png || exit 25
convert ~/dev/cncf/artwork/rkt/icon/color/rkt-icon-color.png -resize 32x32 grafana/img/rkt32.png || exit 26
