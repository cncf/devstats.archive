...
do
  ...
  if ( [ "$icon" = "cnigenie" ] || [ "$icon" = "keptn" ] || [ "$icon" = "cloudcustodian" ] || [ "$icon" = "litmuschaos" ] || [ "$icon" = "kuma" ] || [ "$icon" = "contour" ] || [ "$icon" = "operatorframework" ] || [ "$icon" = "istio" ] || [ "$icon" = "knative" ] || [ "$icon" = "contrib" ] || [ "$icon" = "sam" ] || [ "$icon" = "azf" ] || [ "$icon" = "riff" ] || [ "$icon" = "fn" ] || [ "$icon" = "openwhisk" ] || [ "$icon" = "openfaas" ] || [ "$icon" = "cii" ] )
  then
    icon="cncf"
  fi
