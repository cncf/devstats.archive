...
convert ~/dev/cncf/artwork/prometheus/icon/color/prometheus-icon-noborder-color.png -resize 32x32 grafana/img/prometheus32.png || exit 11
convert ~/dev/cncf/artwork/opentracing/icon/color/opentracing-icon-noborder-color.png -resize 32x32 grafana/img/opentracing32.png || exit 12
convert ~/dev/cncf/artwork/fluentd/icon/color/fluentd-icon-noborder-color.png -resize 32x32 grafana/img/fluentd32.png || exit 13
convert ~/dev/cncf/artwork/linkerd/icon/color/linkerd-icon-noborder-color.png -resize 32x32 grafana/img/linkerd32.png || exit 14
convert ~/dev/cncf/artwork/grpc/icon/color/grpc-icon-noborder-color.png -resize 32x32 grafana/img/grpc32.png || exit 15
convert ~/dev/cncf/artwork/coredns/icon/color/core-dns-icon-noborder-color.png -resize 32x32 grafana/img/coredns32.png || exit 16
convert ~/dev/cncf/artwork/containerd/icon/color/containerd-icon-noborder-color.png -resize 32x32 grafana/img/containerd32.png || exit 17
convert ~/dev/cncf/artwork/cncf/icon/color/cncf-icon-noborder-color.png -resize 32x32 grafana/img/cncf32.png || exit 18
echo 'OK'
