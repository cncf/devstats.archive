...
do
  ...
  if ( [ "$icon" = "cnigenie" ] || [ "$icon" = "keptn" ] || [ "$icon" = "kudo" ] || [ "$icon" = "cloudcustodian" ] || [ "$icon" = "dex" ] || [ "$icon" = "litmuschaos" ] || [ "$icon" = "artifacthub" ] || [ "$icon" = "kuma" ] || [ "$icon" = "parsec" ] || [ "$icon" = "bfe" ] || [ "$icon" = "crossplane" ] || [ "$icon" = "istio" ] || [ "$icon" = "knative" ] || [ "$icon" = "contrib" ] || [ "$icon" = "sam" ] || [ "$icon" = "azf" ] || [ "$icon" = "riff" ] || [ "$icon" = "fn" ] || [ "$icon" = "openwhisk" ] || [ "$icon" = "openfaas" ] || [ "$icon" = "cii" ] )
  then
    icon="cncf"
  fi
