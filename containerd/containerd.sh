...
GHA2DB_PROJECT=containerd IDB_DB=containerd PG_DB=containerd GHA2DB_LOCAL=1 ./gha2db 2015-12-17 0 2017-11-08 0 'containerd,docker/containerd' 2>>errors.txt | tee -a run.log || exit 2
...
./containerd/get_repos.sh 2>>errors.txt | tee -a run.log || exit 9
