...
GHA2DB_PROJECT=containerd IDB_DB=containerd PG_DB=containerd GHA2DB_LOCAL=1 ./gha2db 2015-12-04 0 2017-11-08 0 'containerd' 2>>errors.txt | tee -a run.log || exit 2
GHA2DB_PROJECT=containerd IDB_DB=containerd PG_DB=containerd GHA2DB_LOCAL=1 ./gha2db 2017-11-08 2 today now 'containerd' 2>>errors.txt | tee -a run.log || exit 3
