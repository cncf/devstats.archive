...
# GHA2DB_PROJECT=opennetworkinglab PG_DB=opennetworkinglab GHA2DB_LOCAL=1 ./gha2db 2018-11-01 0 today now opennetworkinglab 2>>errors.txt | tee -a run.log || exit 3
