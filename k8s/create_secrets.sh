...
kubectl create secret generic pg-db --from-file=./k8s/secrets/PG_HOST.secret --from-file=./k8s/secrets/PG_PASS.secret --from-file=./k8s/secrets/PG_PASS_RO.secret --from-file=./k8s/secrets/PG_PASS_TEAM.secret --from-file=./k8s/secrets/PG_PORT.secret --from-file=./k8s/secrets/PG_ADMIN_USER.secret
