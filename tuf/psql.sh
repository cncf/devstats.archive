...
GHA2DB_PROJECT=tuf IDB_DB=tuf PG_DB=tuf ./shared/import_affs.sh 2>>errors.txt | tee -a run.log || exit 6
...
GHA2DB_PROJECT=tuf PG_DB=tuf GHA2DB_LOCAL=1 ./pdb_vars || exit 9
