...
GHA2DB_PROJECT=tuf IDB_DB=tuf PG_DB=tuf GHA2DB_LOCAL=1 GHA2DB_EXACT=1 GHA2DB_OLDFMT=1 ./gha2db 2014-01-02 0 2014-12-31 23 'theupdateframework' 2>>errors.txt | tee -a run.log || exit 3
