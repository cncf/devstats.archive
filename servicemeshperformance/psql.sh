...
GHA2DB_PROJECT=servicemeshperformance PG_DB=servicemeshperformance GHA2DB_LOCAL=1 gha2db 2019-02-02 0 today now 'regexp:(?i)layer5io\/.*(service-mesh|performance|benchmark)' 2>>errors.txt | tee -a run.log || exit 2
