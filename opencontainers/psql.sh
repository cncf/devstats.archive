...
GHA2DB_PROJECT=opencontainers IDB_DB=opencontainers PG_DB=opencontainers GHA2DB_LOCAL=1 ./gha2db 2015-06-22 0 today now 'opencontainers' 2>>errors.txt | tee -a run.log || exit 2
