...
GHA2DB_PROJECT=notary PG_DB=notary GHA2DB_LOCAL=1 gha2db 2015-06-22 0 today now 'notaryproject,theupdateframework/notary,docker/notary' 2>>errors.txt | tee -a run.log || exit 2
