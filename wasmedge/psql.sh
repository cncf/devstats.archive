...
GHA2DB_PROJECT=wasmedge PG_DB=wasmedge GHA2DB_LOCAL=1 gha2db 2018-10-11 0 today now 'wasmerio,WAFoundation,wafoundation,getwasmer,wampio/wasmer' 2>>errors.txt | tee -a run.log || exit 2
