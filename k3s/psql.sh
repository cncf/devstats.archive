...
GHA2DB_EXCLUDE_REPOS='k3s-io/klog,k3s-io/containerd,k3s-io/cri-tools,k3s-io/etcd,k3s-io/flannel,k3s-io/go-powershell,k3s-io/kubernetes,k3s-io/nocode' GHA2DB_PROJECT=k3s PG_DB=k3s GHA2DB_LOCAL=1 gha2db 2018-05-31 0 today now 'k3s-io' 2>>errors.txt | tee -a run.log || exit 2
