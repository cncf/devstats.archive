...
You can use already populated Postgres dump: [Kubernetes Psql dump](https://devstats.k8s.io/web/k8s.sql.xz) (more than 380 Mb, more than 7,5Gb uncompressed)
...
- Completed dump <https://devstats.k8s.io/web/k8s.sql.xz>
