...
You can use already populated Postgres dump: [Kubernetes Psql dump](https://devstats.web.io/gha.sql.xz) (more than 380 Mb, more than 7,5Gb uncompressed)
...
- Completed [dump](https://devstats.web.io/gha.sql.xz).
...
You can also use already populated Postgres dump: [Kubernetes Psql dump](https://devstats.web.io/gha.sql.xz)
