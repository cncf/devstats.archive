...
GHA2DB_PROJECT=fluentd IDB_DB=fluentd PG_DB=fluentd GHA2DB_LOCAL=1 GHA2DB_OLDFMT=1 ./gha2db 2012-01-01 0 2014-12-31 23 'fluent' 2>>errors.txt | tee -a run.log || exit 3
