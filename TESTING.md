...
- Run tests like this: `PG_PASS=... GHA2DB_PROJECT=kubernetes IDB_HOST="localhost" IDB_DB=dbtest IDB_PASS=idbpwd PG_DB=dbtest make dbtest`.
- Or use script shortcut: `PG_PASS=... GHA2DB_PROJECT=kubernetes IDB_HOST="localhost" IDB_PASS=pwd ./dbtest.sh`.
...
- To test single file that requires database: `PG_PASS=... GHA2DB_PROJECT=kubernetes IDB_HOST="localhost" IDB_PASS=pwd go test file_name.go`.
