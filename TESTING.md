...
- Run tests like this: `GHA2DB_PROJECT=kubernetes IDB_DB=dbtest IDB_PASS=idbpwd PG_DB=dbtest PG_PASS=pgpwd make dbtest`.
- Or use script shortcut: `GHA2DB_PROJECT=kubernetes PG_PASS=pwd IDB_PASS=pwd ./dbtest.sh`.
