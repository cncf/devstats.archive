...
update gha_repos set repo_group = 'SIG IBMCloud' where name in (
...
update gha_repos set repo_group = 'Product Security Committee' where name in (
  'kubernetes/security'
);

update gha_repos set repo_group = 'Steering Committee' where name in (
