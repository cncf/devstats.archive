...
- One is [kubernetes/setup_scripts.s](https://github.com/cncf/devstats/blob/master/kubernetes/setup_scripts.sh#L6) which adds postprocess script:
...
- These [lines](https://github.com/cncf/devstats/blob/master/util_sql/postprocess_repo_groups.sql#L10-L12) setting repo group based on full path including repo name.
- These [lines](https://github.com/cncf/devstats/blob/master/util_sql/postprocess_repo_groups.sql#L23-L34) setting repo group based on PR review comments on specific files in specific repository.
- Another is [kubernetes/setup_scripts.s](https://github.com/cncf/devstats/blob/master/kubernetes/setup_scripts.sh#L8) which adds postprocess script::
