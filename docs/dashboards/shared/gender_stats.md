...
<li>We are determining contributor's gender by using GitHub localization and user name to query store.genderize.io for gender for given country and name.</li>
