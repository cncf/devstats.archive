<h1 id="kubernetes-ghstats-dashboard">Kubernetes GitHub stats dashboard (issues opened)</h1>
<p>Links:</p>
<ul>
...
<li>Selecting period (for example week) means that dahsboard will count issues opened in these period.</li>
