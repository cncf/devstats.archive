<h1 id="kubernetes-ghstats-dashboard">Kubernetes GitHub stats dashboard (issues closed)</h1>
<p>Links:</p>
<ul>
...
<ul>
<li>This documentations only refers to <code>Issues closed</code> statistic.
...
<li>Selecting period (for example week) means that dahsboard will count issues closed in these period.</li>
