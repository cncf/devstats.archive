<h1 id="kubernetes-ghstats-dashboard">Kubernetes GitHub stats dashboard (PRs closed)</h1>
<p>Links:</p>
<ul>
...
<ul>
<li>This documentations only refers to <code>PRs closed</code> statistic.
...
<li>Selecting period (for example week) means that dahsboard will count PRs closed in these period.</li>
