<h1 id="kubernetes-ghstats-dashboard">Kubernetes GitHub stats dashboard (PRs opened)</h1>
<p>Links:</p>
<ul>
...
<ul>
<li>This documentations only refers to <code>PRs opened</code> statistic.
...
<li>Selecting period (for example week) means that dahsboard will count PRs opened in these period.</li>
