<h1 id="kubernetes-ghstats-dashboard">Kubernetes GitHub stats dashboard (PRs merged)</h1>
<p>Links:</p>
<ul>
...
<ul>
<li>This documentations only refers to <code>PRs merged</code> statistic.
...
<li>Selecting period (for example week) means that dahsboard will count PRs merged in these period.</li>
