...
- Orgs are created during standard GitHub archives import from JSON [here](https://github.com/cncf/devstats/blob/master/cmd/gha2db/gha2db.go#L34-L44).
- Org name can change name in time (probably?), but organization ID remains the same in this case.
- It contains about 6 records as of Mar 2018.
