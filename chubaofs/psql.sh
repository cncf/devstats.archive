...
GHA2DB_PROJECT=chubaofs PG_DB=chubaofs GHA2DB_LOCAL=1 gha2db 2018-09-29 0 today now 'chubaofs,containerfs/containerfs.github.io,containerfilesystem/cfs,containerfilesystem/doc-zh' 2>>errors.txt | tee -a run.log || exit 2
