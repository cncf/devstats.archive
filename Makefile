...
GO_TEST_FILES=test/context_test.go
...
fmt: ${GO_BIN_FILES} ${GO_LIB_FILES} ${GO_TEST_FILES}
	${GO_FMT} ${GO_LIB_FILES}
	${GO_FMT} ${GO_BIN_FILES}
	${GO_FMT} ${GO_TEST_FILES}

lint: ${GO_BIN_FILES} ${GO_LIB_FILES} ${GO_TEST_FILES}
	${GO_LINT} ${GO_LIB_FILES}
	${GO_LINT} ${GO_BIN_FILES}
	${GO_LINT} ${GO_TEST_FILES}

imports: ${GO_BIN_FILES} ${GO_LIB_FILES} ${GO_TEST_FILES}
