...
GO_TEST=go test
BINARIES=structure runq gha2db db2influx z2influx gha2db_sync import_affs annotations idb_tags idb_backup webhook devstats get_repos merge_pdbs idb_vars
...
clean:
	rm -f structure runq gha2db db2influx z2influx gha2db_sync devstats import_affs annotations idb_tags idb_backup webhook get_repos merge_pdbs idb_vars
