...
GO_BIN_CMDS=devstats/cmd/structure devstats/cmd/runq devstats/cmd/gha2db devstats/cmd/db2influx devstats/cmd/gha2db_sync devstats/cmd/z2influx devstats/cmd/import_affs devstats/cmd/annotations devstats/cmd/idb_tags devstats/cmd/webhook devstats/cmd/devstats devstats/cmd/get_repos devstats/cmd/merge_pdbs devstats/cmd/replacer devstats/cmd/pdb_vars devstats/cmd/ghapi2db devstats/cmd/sqlitedb
...
GO_TEST=go test
BINARIES=structure runq gha2db db2influx z2influx gha2db_sync import_affs annotations idb_tags webhook devstats get_repos merge_pdbs replacer pdb_vars ghapi2db sqlitedb
