...
GHA2DB_PROJECT=kuma PG_DB=kuma GHA2DB_LOCAL=1 gha2db 2019-09-09 0 today now 'kumahq,Kong/kuma,Kong/kuma-website,Kong/kuma-demo,Kong/kuma-gui,Kong/kumacut' 2>>errors.txt | tee -a run.log || exit 2
