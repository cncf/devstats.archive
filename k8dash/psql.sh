...
GHA2DB_PROJECT=k8dash PG_DB=k8dash GHA2DB_LOCAL=1 gha2db 2019-03-05 0 today now 'indeedeng/k8dash,indeedeng/k8dash-website,herbrandson/k8dash' 2>>errors.txt | tee -a run.log || exit 2
