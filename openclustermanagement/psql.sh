...
GHA2DB_PROJECT=openclustermanagement PG_DB=openclustermanagement GHA2DB_LOCAL=1 gha2db 2020-04-20 0 today now 'open-cluster-management-io,open-cluster-management' 2>>errors.txt | tee -a run.log || exit 2
