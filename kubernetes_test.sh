...
#PG_DB=test ./gha2db 2017-08-29 0 2017-08-31 0 || exit 2
#PG_DB=test GHA2DB_EXACT=1 ./gha2db 2015-07-07 0 2015-07-09 0 || exit 3
PG_DB=test GHA2DB_OLDFMT=1 ./gha2db 2014-11-04 0 2014-11-06 0 || exit 4
