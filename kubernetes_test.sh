...
GHA2DB_LOCAL=1 PG_DB=test ./gha2db 2017-08-29 0 2017-08-31 0 'kubernetes,kubernetes-client,kubernetes-incubator,kubernetes-helm' 2>>errors.txt | tee -a run.log || exit 2
